(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".hero-slider")) new core(".hero-slider", {
        ...
        function mapInit(n = 1) {
            ...
            let locations = [ [ new google.maps.LatLng(53.819055, 27.8813694) ], [ new google.maps.LatLng(53.700055, 27.5513694) ], [ new google.maps.LatLng(53.809055, 27.5813694) ], [ new google.maps.LatLng(53.859055, 27.5013694) ] ];
            var options = {
                zoom: 10,
                panControl: false,
...
*/        var Observer_gsap, Observer_coreInitted, Observer_win, Observer_doc, _docEl, _body, _isTouch, _pointerType, ScrollTrigger, _root, _normalizer, _eventTypes, _getGSAP = function _getGSAP() {
        ...
        Observer_Observer.version = "3.11.3";
...
*/
        ...
        if ("/" == window.location.pathname || /index.html/i.test(url)) {
            const block1 = {
                heading: document.querySelector(".services__sub-title"),
                text: document.querySelector(".services__text")
            };
            let block1Tl = gsapWithCSS.timeline({
                scrollTrigger: {
                    trigger: ".services",
            ...
            block1Tl.from(block1.heading, {
                ...
                opacity: 0,
                duration: .7
            }, "-=0.5").from(".list-services__card", {
                opacity: 0,
                y: 400,
                duration: 1.25
            }, "-=1").from(".card-service__heading", {
                opacity: 0,
                x: 400,
                duration: 1.25
            }, "-=1.2").from(".card-service__image", {
                opacity: 0,
                x: -400,
                duration: 1.5
            }, "-=1.2").from(".card-service__text", {
                opacity: 0,
                y: 400,
                duration: 1.5
            }, "-=1");
            let block2Tl = gsapWithCSS.timeline({
                scrollTrigger: {
                    trigger: ".about",
                    toggleActions: "restart none none none",
                    start: "top bottom"
            ...
            block2Tl.from(".about__heading", {
                ...
                duration: 1.5,
                opacity: 0
            }, "-=1.25").from(".about__button", {
                scale: 0,
                duration: 1.5,
                opacity: 0
            }, "-=1.25");
            gsapWithCSS.from(".offer__element", {
                scale: 0,
                opacity: 0,
                y: 500,
                duration: 1.5,
                scrollTrigger: {
                    trigger: ".offer__element",
                    start: "-=400px bottom",
                    toggleActions: "restart none none none"
                }
            });
            let block3Tl = gsapWithCSS.timeline({
                scrollTrigger: {
                    trigger: ".benefits",
                    toggleActions: "restart none none none",
                    start: "top bottom"
            ...
            block3Tl.from(".benefits__sub-title", {
                x: -300,
                opacity: 0,
                duration: 1.5
            }).from(".list-benefits__card", {
                y: 300,
                opacity: 0,
                duration: 1.5
            }, "-=1.2").from(".card-benefits__number", {
                x: 300,
                opacity: 0,
                duration: 1.3
            }, "-=1.5").from(".card-benefits__heading", {
                x: 300,
                opacity: 0,
                duration: 1.2
            }, "-=1.5").from(".card-benefits__text", {
                x: 300,
                opacity: 0,
                duration: 1.2
            }, "-=1.5");
            let block4Tl = gsapWithCSS.timeline({
                scrollTrigger: {
                    trigger: ".guarantees",
                    toggleActions: "restart none none none",
                    start: "top bottom"
            ...
            block4Tl.from(".guarantees__text-box", {
                y: 300,
                opacity: 0,
                duration: 1.5
            }).from(".guarantees__image", {
                x: 300,
                opacity: 0,
                duration: 1.75
            }, "-=1.5");
            let block5Tl = gsapWithCSS.timeline({
                scrollTrigger: {
                    trigger: ".info",
                    toggleActions: "restart none none none",
                    start: "+=50% bottom"
        ...
        let script_url = location.href;
        const upToBtn = document.querySelector(".up-to-button");
        if ("/" == window.location.pathname || /index.html/i.test(script_url)) upToBtn.setAttribute("data-goto", "#heroHome"); else if (/services.html/i.test(script_url)) upToBtn.setAttribute("data-goto", "#servicesHero");
        const mobMenuBg = document.querySelector(".mobile-menu__background");
        mobMenuBg.addEventListener("click", (() => {
            document.documentElement.classList.remove("menu-open");
            bodyUnlock();
        }));
        window["FLS"] = false;
